...
class Button(pygame.sprite.Sprite):
    def __init__(self, dirrectory, xy, WIDTH_HEIGHT, sound, text, target=None, arg=None):
        ...
        for image in os.listdir(dirrectory + '\\on_press'):
            if '.' in image:
                self.images_press.append(pygame.image.load(dirrectory + '\\on_press\\' + image))
    ...
    def update(self):
        ...
        self.image.blit(self.text_result, self.text_result.get_rect(center=self.image.get_rect().center))
